...
public class CJUpOriginalImpl implements CJUpOriginalInterface {
	private int result;
	@Override
	public void getCJUpOriginal(BClass[] blist, String equipbrand,
				...
				context, new CJUpOriginalDataCallBack() {
					...
					public void processData(CJResutResult data) {
						...
						if(result !=0){
							...
							break;
							case -2:pubUtil.exception.setExceptionMsg("equipbrand有误");
							break;
							case -3:pubUtil.exception.setExceptionMsg("instrumodel有误");
							break;
							case -4:pubUtil.exception.setExceptionMsg("serialnum有误");
							break;
							case -5: pubUtil.exception.setExceptionMsg("sjid有误");
							break;
							case -6:pubUtil.exception.setExceptionMsg("temperature有误");
							break;
							case -7:pubUtil.exception.setExceptionMsg("barometric有误");
							break;
							case -8:pubUtil.exception.setExceptionMsg("weather有误");
							break;
							case -9:pubUtil.exception.setExceptionMsg("benchmarkids有误");
							break;
							case -10:pubUtil.exception.setExceptionMsg("mtype有误");
							break;
							case -11:pubUtil.exception.setExceptionMsg("mdate有误");
							break;
							case -12:pubUtil.exception.setExceptionMsg("linecode有误");
							break;
							case -13:pubUtil.exception.setExceptionMsg("account有误");
							break;
							case -14:pubUtil.exception.setExceptionMsg("pwd有误");
							break;
		...
		Log.i("上传原始数据结果impl：","resultCode is:"+pubUtil.downReturnCode.getReturnOrgCode());
	}
